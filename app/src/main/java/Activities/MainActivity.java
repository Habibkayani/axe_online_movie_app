...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    List<HomeBannerMovies> kidsHomeBannerMoviesList;
    List<HomeBannerMovies> moviesHomeBannerMoviesList;
    ...
    TabItem Movies,TvShows,Home;
    MainActivityNavigationPageAdapter adapter;
...
//set tabs
       ...
       navtext=findViewById(R.id.nav_text);
        ...
        adapter=new MainActivityNavigationPageAdapter(getSupportFragmentManager(), FragmentPagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT,mTabLayout.getTabCount());
...
//        homeBannerMoviesList.add(new BannerMovies(1, "PONMANGAL VANDHAI", "http://androidappsforyoutube.s3.ap-south-1.amazonaws.com/primevideo/banners/homebanner1.png", "http://androidappsforyoutube.s3.ap-south-1.amazonaws.com/primevideo/patallok.mp4"));
//        homeBannerMoviesList.add(new BannerMovies(2, "LITTLE WOMEN", "http://androidappsforyoutube.s3.ap-south-1.amazonaws.com/primevideo/banners/homebanner2.png", "http://androidappsforyoutube.s3.ap-south-1.amazonaws.com/primevideo/patallok.mp4"));
//        homeBannerMoviesList.add(new BannerMovies(3, "BHOOT THE HAUNTED SHIP", "http://androidappsforyoutube.s3.ap-south-1.amazonaws.com/primevideo/banners/homebanner3.png", "http://androidappsforyoutube.s3.ap-south-1.amazonaws.com/primevideo/patallok.mp4"));
//        homeBannerMoviesList.add(new BannerMovies(4, "MIRZAPUR", "http://androidappsforyoutube.s3.ap-south-1.amazonaws.com/primevideo/banners/homebanner4.png", "http://androidappsforyoutube.s3.ap-south-1.amazonaws.com/primevideo/patallok.mp4"));
//        homeBannerMoviesList.add(new BannerMovies(5, "PIKACHU", "http://androidappsforyoutube.s3.ap-south-1.amazonaws.com/primevideo/banners/homebanner5.png", "http://androidappsforyoutube.s3.ap-south-1.amazonaws.com/primevideo/patallok.mp4"));
//        setBannerMoviesPagerAdapter(homeBannerMoviesList);
//        ///tvshows////
