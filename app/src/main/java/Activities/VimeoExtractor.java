...
public class VimeoExtractor {
     ...
     */
    public void fetchVideoWithIdentifier( String identifier, @Nullable String referrer, final OnVimeoExtractionListener listener){
     ...
     * @param listener Callback from extraction
     */
    public void fetchVideoWithURL(String videoURL, @Nullable String referrer,final OnVimeoExtractionListener listener){
