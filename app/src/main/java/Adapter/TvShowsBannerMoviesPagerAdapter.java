...
public class TvShowsBannerMoviesPagerAdapter extends PagerAdapter {
    private static final String TAG = "TAG";
    Context context;
    List<TvShowsBannerMovies> homeBannerMoviesList;

    public TvShowsBannerMoviesPagerAdapter(Context context, List<TvShowsBannerMovies> homeBannerMoviesList) {
